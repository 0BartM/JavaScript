    ...
    $(function(){
        ...
        var renderMovies = function(movies){
            ...
            for(var i = 0; i < movies.results.length; i++)
            {
                ...
                $("<div>").attr("class","filmIndex"+i).appendTo("#listeFilmsIndex");
                $("<div>").attr("class","filmImageIndex"+i).appendTo(".filmIndex"+i);
                ...
                $("<div>").attr("class","detailsFilmIndex"+i).appendTo(".filmIndex"+i);
